...
import {
    ...
    loadAddEspecialidadFailed, loadDeleteEspecialidad, loadDeleteEspecialidadSuccess, loadDeleteEspecialidadFailed
} from '../actions';
...
export class EspecialidadesEffects {
    ...
    loadAddEspecialidad$ = createEffect(() => this.action$.pipe(
        ...
        switchMap((data: Especialidad) => this.especialidadesService.addEspecialidad(data).pipe(
            map((especialidad) => loadAddEspecialidadSuccess({ newEspecialidad: especialidad })),
    ...
    loadDeleteEspecialidad = createEffect(() => this.action$.pipe(
        ...
        switchMap((id: string) => this.especialidadesService.deleteEspecialidad(id).pipe(
